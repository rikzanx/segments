...
class PenilaianKinerjaDetailKpi extends StatefulWidget {
  final String bulan;
  final String nik;
  final String judul;
  final String tahun;
  const PenilaianKinerjaDetailKpi(
      {super.key, required this.bulan, required this.nik, required this.judul, required this.tahun});

  @override
  PenilaianKinerjaDetailKpiState createState() => PenilaianKinerjaDetailKpiState();
}

class PenilaianKinerjaDetailKpiState extends State<PenilaianKinerjaDetailKpi> {
