...
import 'package:segments/additionpage/list_data_detail/list_lembur_khusus_detail.dart';
import 'package:segments/constant.dart';
import 'package:segments/function/route.dart';
import 'package:segments/my_function.dart';

class ListLemburKhusus extends StatefulWidget {
  const ListLemburKhusus({super.key});

  @override
  ListLemburKhususState createState() => ListLemburKhususState();
}

class ListLemburKhususState extends State<ListLemburKhusus> {
  String _nik = '';
              ...
              for (int i = 0; i < tipe.length; i++)
                LitleCardFunction(
                    fungsi: () {
                      pindahPageCupertino(
                          context,
                          ListLemburKhususDetail(
                            tipe: i.toString(),
                            nik: _nik.toString(),
                            judul: "Lembur Khusus yang${tipe[i]}",
                          ));
                    },
